...
# ── User Settings (Ajustes de personalización y notificaciones) ───────────────
class UserSettings(Base):
    ...
    # ── AI Personalization ────────────────────────────────────────────────────
    # "friendly" | "professional" | "motivational"
    ai_tone: Mapped[str] = mapped_column(String(32), default="friendly")
    # Free-form text the user adds as permanent context for Marco
    custom_instructions: Mapped[str | None] = mapped_column(Text, nullable=True)
    # Response language (reserved for future use)
